...
async function GET(req, { params }) {
    ...
    try {
        const project = await __TURBOPACK__imported__module__$5b$project$5d2f$cses$2d$database$2f$models$2f$project$2e$model$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(id);
        if (!project) {
...
async function PUT(req, { params }) {
    ...
    try {
        ...
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$cses$2d$database$2f$models$2f$project$2e$model$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(id, body, {
            new: true
        });
        if (!updated) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$cses$2d$database$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function DELETE(req, { params }) {
    ...
    const { id } = await params;
    try {
        const deleted = await __TURBOPACK__imported__module__$5b$project$5d2f$cses$2d$database$2f$models$2f$project$2e$model$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndDelete(id);
        if (!deleted) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$cses$2d$database$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: "Project not found"
            }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__86d8b2a0._.js.map