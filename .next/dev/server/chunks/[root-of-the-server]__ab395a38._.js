...
async function GET(req, { params }) {
    ...
    try {
        const experience = await __TURBOPACK__imported__module__$5b$project$5d2f$cses$2d$database$2f$experience$2e$model$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(params.id);
        if (!experience) {
...
async function PUT(req, { params }) {
    ...
    try {
        ...
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$cses$2d$database$2f$experience$2e$model$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(params.id, body, {
            new: true
        });
        if (!updated) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$cses$2d$database$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function DELETE(req, { params }) {
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$cses$2d$database$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectDB"])();
    try {
        const deleted = await __TURBOPACK__imported__module__$5b$project$5d2f$cses$2d$database$2f$experience$2e$model$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndDelete(params.id);
        if (!deleted) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$cses$2d$database$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: "Experience not found"
            }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ab395a38._.js.map