...
async function GET() {
    ...
    try {
        const experiences = await __TURBOPACK__imported__module__$5b$project$5d2f$cses$2d$database$2f$models$2f$experience$2e$model$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find().sort({
            startDate: -1
        });
...
async function POST(req) {
    ...
    try {
        ...
        const experience = await __TURBOPACK__imported__module__$5b$project$5d2f$cses$2d$database$2f$models$2f$experience$2e$model$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create(body);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__81fce2bd._.js.map